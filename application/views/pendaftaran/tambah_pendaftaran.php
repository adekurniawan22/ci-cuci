                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="<?= base_url() ?>pendaftaran/proses_tambah_pendaftaran" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="poliklinik" class="form-select" aria-label="Default select example" name="poliklinik">
                                        <option value="" selected>Pilih Poliklinik</option>
                                        <option value="Poliklinik Mata" <?php echo set_select('poliklinik', 'Poliklinik Mata'); ?>>Poliklinik Mata</option>
                                        <option value="Poliklinik Kulit" <?php echo set_select('poliklinik', 'Poliklinik Kulit'); ?>>Poliklinik Kulit</option>
                                        <option value="Poliklinik Saraf" <?php echo set_select('poliklinik', 'Poliklinik Saraf'); ?>>Poliklinik Saraf</option>
                                    </select>
                                    <?= form_error('poliklinik', '<p style="font-size: 12px;color: red;" class="my-2">', '</p>'); ?>
                                </div>
                            </div>
